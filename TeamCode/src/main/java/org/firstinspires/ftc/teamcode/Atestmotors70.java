...
//
//@TeleOp(name = "Atestmotors 70")
//public class Atestmotors70 extends LinearOpMode {
...
//
//                robot.LFMotor.setPower(0.7);
//                robot.RFMotor.setPower(0.7);
//                robot.LBMotor.setPower(0.7);
//                robot.RBMotor.setPower(0.7);
//
