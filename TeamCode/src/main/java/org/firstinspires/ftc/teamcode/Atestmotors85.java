...
//
//@TeleOp(name = "Atestmotors 85")
//public class Atestmotors85 extends LinearOpMode {
...
//
//                robot.LFMotor.setPower(0.85);
//                robot.RFMotor.setPower(0.85);
//                robot.LBMotor.setPower(0.85);
//                robot.RBMotor.setPower(0.85);
//
