...
//
//@TeleOp(name = "Atestmotors 55")
//public class Atestmotors55 extends LinearOpMode {
...
//
//                robot.LFMotor.setPower(0.55);
//                robot.RFMotor.setPower(0.55);
//                robot.LBMotor.setPower(0.55);
//                robot.RBMotor.setPower(0.55);
//
