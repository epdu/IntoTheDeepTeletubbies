...
//
//@TeleOp(name = "Atestmotors 90")
//public class Atestmotors90 extends LinearOpMode {
...
//
//                robot.LFMotor.setPower(0.9);
//                robot.RFMotor.setPower(0.9);
//                robot.LBMotor.setPower(0.9);
//                robot.RBMotor.setPower(0.9);
//
